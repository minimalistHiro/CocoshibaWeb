...
class EventCreatePage extends StatefulWidget {
  const EventCreatePage({super.key, this.initialDate});
...
class _EventCreatePageState extends State<EventCreatePage> {
  ...
  void initState() {
    ...
    _startDateTime = DateTime(initial.year, initial.month, initial.day, 10, 0);
    _endDateTime = _defaultEndForStart(_startDateTime);
  }
